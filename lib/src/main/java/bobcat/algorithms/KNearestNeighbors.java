...
public class KNearestNeighbors {
    ...
    // Constructor
    public KNearestNeighbors(int nodeNumber, int seed, double squareSide,
    ...
    public static void main(String [] args){
        ...
        int beams = 8;
        KNearestNeighbors gr =
                new KNearestNeighbors(nodeNumber, seed, squareSide, neighborsNumber, beams);
